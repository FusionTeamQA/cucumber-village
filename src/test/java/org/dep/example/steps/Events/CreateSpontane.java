...
public class CreateSpontane extends Driver {
    ...
    public void auth_CreateSpontane() {
    ...
    @Given("Open page Events|CreateSpontane")
    public void open_page_Events_CreateSpontane() {
        driver.get(URL);
    ...
    public void click_button_Neues_Event_CreateSpontane() {
        WebDriverWait wait = new WebDriverWait(driver,30);
    ...
    @When("Enter Titel des Events|CreateSpontane")
    public void enter_Titel_des_Events_CreateSpontane() {
        driver.findElement(By.name("title")).sendKeys(Einrichtung +n);
    }

    @When("Enter Datum auswählen|CreateSpontane")
    public void enter_Datum_auswählen_CreateSpontane() {
    ...
    @When("Enter Uhrzeit wählen|CreateSpontane")
    public void enter_Uhrzeit_wählen_CreateSpontane() {
        driver.findElement(By.name("start")).sendKeys("1500");
    }

    @When("Enter Ende \\(Optional)|CreateSpontane")
    public void enter_Ende_Optional_CreateSpontane() {
        driver.findElement(By.name("end")).sendKeys("1800");
    }

    @When("Enter Ort der Veranstaltung \\(Adresse)|CreateSpontane")
    public void enter_Ort_der_Veranstaltung_Adresse_CreateSpontane() {
        driver.findElement(By.name("address")).sendKeys(Hausnummer);
    }

    @When("Enter Beschreibung|CreateSpontane")
    public void enter_Beschreibung_CreateSpontane() {
        driver.findElement(By.xpath("//*[@id=\"new-event-form\"]/div[6]/textarea")).sendKeys(Anmerkungen);
    }

    @When("Click botton Weiter|CreateSpontane")
    public void click_botton_Weiter_CreateSpontane() {
        driver.findElement(By.xpath("//*[@id=\"new-event-form\"]/button/span[1]")).click();
    }

    @When("Select type Spontanes|CreateSpontane")
    public void select_type_Spontanes_CreateSpontane() {
        WebDriverWait wait3 = new WebDriverWait(driver,30);
        wait3.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"scroll-container\"]/div[2]/div/button/span[1]")));
    }

    @When("Click botton Weitertwo|CreateSpontane")
    public void click_botton_Weitertwo_CreateSpontane() {
        driver.findElement(By.xpath("//*[@id=\"scroll-container\"]/div[2]/div/button/span[1]")).click();
    }

    @When("Upload image|CreateSpontane")
    public void upload_image_CreateSpontane() {
        WebElement fileInput = driver.findElement(By.cssSelector("input[type=file]"));
        fileInput.sendKeys("/Users/fusion_tech/Documents/testImg/test.png");
    }

    @When("Click button Veröffentlichen|CreateSpontane")
    public void click_button_Veröffentlichen_CreateSpontane() {
    ...
    public void event_spontanes_succesfull_create_CreateSpontane() {
    ...
    @Then("Close Browser|CreateSpontane")
    public void close_Browser_CreateSpontane() {
        driver.close();
    }
}
