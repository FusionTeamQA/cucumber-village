...
//    public void click_button_Postens_AddCommentNewPost() throws InterruptedException {
...
//    public void form_send_Successful_AddCommentNewPost() throws InterruptedException {
//        System.out.println("Введено значение" + TitleNews + n);
//        WebElement element = driver.findElement(By.xpath("//*[@id=\"posts-container\"]/div[6]/div/div[3]/div[1]/div/div[2]/span"));
...
//        new Actions(driver).moveByOffset(603, 536).click().build().perform();
//        new Actions(driver).moveByOffset(476, 675).sendKeys(Nachricht).build().perform();
//    }
//
//    @Then("Click button Posten|AddCommentNewPost")
//    public void click_button_Posten_AddCommentNewPost() throws InterruptedException {
//        Thread.sleep(1500);
