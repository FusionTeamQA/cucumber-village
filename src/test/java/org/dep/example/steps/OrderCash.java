...
public class OrderCash extends Driver {
    ...
    @When("Click botton Quick finder|OrderCash")
    public void click_botton_Quick_finder_OrderCash() throws InterruptedException {
    ...
    public void choose_the_quantity_of_the_product_Arizona_Iced_Tea_Blueberry_in_the_size_of_pcs_OrderCash(Integer int1) throws InterruptedException {
    ...
    public void click_botton_checkout_OrderCash() {
    ...
    public void check_the_box_on_I_hereby_accept_Egourmery_s_Terms_and_conditions_and_Privacy_policy_OrderCash() throws InterruptedException {
