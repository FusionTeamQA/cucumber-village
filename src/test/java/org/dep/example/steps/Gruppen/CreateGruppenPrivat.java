...
public class CreateGruppenPrivat extends Driver {
    ...
    public void auth_CreateGruppenPrivat() {
    ...
    @Given("Open page Gruppen|CreateGruppenPrivat")
    public void open_page_Gruppen_CreateGruppenPrivat() {
        driver.get(URL);
    ...
    public void click_button_Neue_Gruppe_erstellen_CreateGruppenPrivat() {
        JavascriptExecutor jse = (JavascriptExecutor)driver;
        jse.executeScript("window.scrollBy(0,250)");
        driver.findElement(By.xpath("//*[@id=\"groups-container\"]/div[4]/div/div")).click();
    }

    @When("Click botton Suche nach Titelbild z.B. Sommer|CreateGruppenPrivat")
    public void click_botton_Suche_nach_Titelbild_z_B_Sommer_CreateGruppenPrivat() {
        driver.findElement(By.xpath("//*[@id=\"new-group-form\"]/div[2]/div[1]/input")).click();

    }

    @When("Click random image|CreateGruppenPrivat")
    public void click_random_image_CreateGruppenPrivat() {
        // Write code here that turns the phrase above into concrete actions
        driver.findElement(By.xpath("//*[@id=\"pixabays-id\"]/img[6]")).click();
    }

    @When("Enter Gruppen name|CreateGruppenPrivat")
    public void enter_Gruppen_name_CreateGruppenPrivat() {
        driver.findElement(By.name("title")).sendKeys(Gruppenname +n);
        System.out.println("Введено название группы:" + Gruppenname + n);
    }

    @When("Enter Beschreibung|CreateGruppenPrivat")
    public void enter_Beschreibung_CreateGruppenPrivat() {
        WebDriverWait wait = new WebDriverWait(driver,30);
    ...
    @When("Select type gruppen|CreateGruppenPrivat")
    public void select_type_gruppen_CreateGruppenPrivat() {
        driver.findElement(By.xpath("//*[@id=\"new-group-form\"]/div[5]/label[2]/span")).click();
        System.out.println("Выбран тип группы Öffentlich");
    }

    @When("Click button Fertig|CreateGruppenPrivat")
    public void click_button_Fertig_CreateGruppenPrivat() {
    ...
    public void gruppen_succesfull_create_CreateGruppenPrivat() {
        JavascriptExecutor jse = (JavascriptExecutor)driver;
        jse.executeScript("window.scrollBy(0,-250)");
        WebDriverWait wait = new WebDriverWait(driver,30);
    ...
    @Then("Close Browser|CreateGruppenPrivat")
    public void close_Browser_CreateGruppenPrivat() {
        driver.close();
    }
